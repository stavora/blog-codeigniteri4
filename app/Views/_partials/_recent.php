    ...
    <div class="row g-5">
        <div class="col-lg-4">
            ...
            <div class="post-entry-1 lg">
                ...
                <div class="post-meta"><span class="date"><?php echo $post->categoryName; ?></span> <span class="mx-1">&bullet;</span> <span><?php echo date('d/m/Y H:i', strtotime($post->created_at)) ?></span></div>
